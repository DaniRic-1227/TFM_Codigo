...
edge = pd.read_csv('D:/Documentos/Master_BigData/14-TFM/VisualStudio/csv/weighted_Edge_list_noaltarifazo.csv')
data = pd.read_csv('D:/Documentos/Master_BigData/14-TFM/VisualStudio/csv/Data_noaltarifazo.csv')
...
if caso == '15m':                                    # change the date here
    ...
    ini = datetime(2019, 01, 05, 14, 00)
    fin = datetime(2019, 01, 05, 15, 00)
    y0 = 1450
    y1 = 7.2
